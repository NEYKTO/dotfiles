...
class _LinuxBattery(_Battery, configurable.Configurable):
    defaults = [
        (
            'status_file',
            None,
            'Name of status file in /sys/class/power_supply/ACAD'
        ),
        (
            'energy_now_file',
            None,
            'Name of file with the current energy in /sys/class/power_supply/ACAD'
        ),
        (
            'energy_full_file',
            None,
            'Name of file with the maximum energy in /sys/class/power_supply/ACAD'
        ),
        (
            'power_now_file',
            None,
            'Name of file with the current power draw in /sys/class/power_supply/ACAD'
        )
    ]
...
class Battery(base.ThreadPoolText):
    ...
    def __init__(self, **config) -> None:
        ...
        base.ThreadPollText.__init__(self, "BAT", bar.CALCULATED, **config)
